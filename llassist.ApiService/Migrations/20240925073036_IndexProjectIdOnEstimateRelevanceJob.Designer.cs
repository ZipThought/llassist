...
namespace llassist.ApiService.Migrations
{
    ...
    [Migration("20240925073036_IndexProjectIdOnEstimateRelevanceJob")]
    partial class IndexProjectIdOnEstimateRelevanceJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("llassist.Common.Models.EstimateRelevanceJob", b =>
                {
                    b.OwnsOne("llassist.Common.Models.ResearchQuestionsSnapshot", "ResearchQuestions", b1 =>
                        {
                            b1.Property<string>("EstimateRelevanceJobId")
                                .HasColumnType("text");
                            ...
                            b1.HasKey("EstimateRelevanceJobId");

                            b1.ToTable("EstimateRelevanceJobs");
                            ...
                            b1.OwnsMany("llassist.Common.Models.QuestionSnapshot", "Questions", b2 =>
                                {
                                    b2.Property<string>("ResearchQuestionsSnapshotEstimateRelevanceJobId")
                                        .HasColumnType("text");
                                    ...
                                    b2.HasKey("ResearchQuestionsSnapshotEstimateRelevanceJobId", "Id");

                                    b2.ToTable("EstimateRelevanceJobs");

                                    b2.WithOwner()
                                        .HasForeignKey("ResearchQuestionsSnapshotEstimateRelevanceJobId");
                                });
